...
`;
    ...
    function preprocess(text) {
        text = String(text);
        // return [text];
        // const stopwordsPath = resolve(__dirname, './d/stopwords.txt'); // Resolve the absolute path
        // const stopwordsPath = './d/stopwords.txt';
        // const stopwords = readFileSync(stopwordsPath, 'utf8');
