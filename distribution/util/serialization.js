...
// }
const serialize = require('@brown-ds/distribution/distribution/util/serialization.js').serialize; 
...
const deserialize = require('@brown-ds/distribution/distribution/util/serialization.js').deserialize; 
